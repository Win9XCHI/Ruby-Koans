...
class AboutMethods < Neo::Koan
  ...
  def test_calling_with_variable_arguments
    ...
    assert_equal Array.new([]), method_with_var_args
    assert_equal Array.new([:one]), method_with_var_args(:one)
    assert_equal Array.new([:one, :two]), method_with_var_args(:one, :two)
  end
