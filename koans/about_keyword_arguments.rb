...
class AboutKeywordArguments < Neo::Koan
  ...
  def test_keyword_arguments
    ...
    assert_equal Array.new([1, 'two']), method_with_keyword_arguments
    assert_equal Array.new(['one', 'two']), method_with_keyword_arguments(one: 'one')
    assert_equal Array.new([1, 2]), method_with_keyword_arguments(two: 2)
  end
